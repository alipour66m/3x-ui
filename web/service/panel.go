...
func (s *PanelService) StartUpdate() error {
	...
	updateScript := fmt.Sprintf("set -o pipefail; %s -fLs https://raw.githubusercontent.com/alipour66m/3x-ui/main/update.sh | %s", shellQuote(curl), shellQuote(bash))
...
func fetchLatestPanelVersion() (string, error) {
	...
	resp, err := client.Get("https://api.github.com/repos/alipour66m/3x-ui/releases/latest")
	if err != nil {
		return "", err
	}
