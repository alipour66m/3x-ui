...
<p align="left">
  <a href="https://buymeacoffee.com/alipour66m" target="_blank">
...
```
VERSION=v1.7.9 && <(curl -Ls "https://raw.githubusercontent.com/alipour66m/3x-ui/$VERSION/install.sh") $VERSION
```
